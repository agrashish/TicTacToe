...
public class AI_MinMax {
    ...
    //we will change the constructor, so that it takes a string array as a parameter
    AI_MinMax(String[] curState)
    {
        //init_board = getBoard();
    	
    	//we will use that string array as our starting board
        init_board = curState;
    ...
    //we create a new function, which simply returns an integer arraylist
    //of all winning or tying moves
    public ArrayList<Integer> intMoveList()
    {
